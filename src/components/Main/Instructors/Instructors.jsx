    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 z-50 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded shadow-lg w-full max-w-[600px]">
          ...
          <FormProvider {...form}>
          <form className="mt-4 flex flex-col items-start w-full gap-2">
          ...
          <input type="text" className=" block w-full p-2 border border-gray-300 rounded" required />
          </div>
           <div className="w-full" >
            <label className="block">Tipo de Usuário: </label>
              <select className=" block w-full p-2 border border-gray-300 rounded" required>
                <option value="1">Administrador Geral</option>
                <option value="2">Gestor</option>
                <option value="3" selected>Formador</option>
              </select>
          </div>
            <Previligies />
