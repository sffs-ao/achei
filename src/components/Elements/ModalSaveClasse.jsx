...
import { POST_CLASSES } from "../../utils/API";
...
export const ModalSaveClasse = () => {
  ...
  async function handleSubmitIntruct(data) {
    ...
    try {
      const response = await POST_CLASSES(data);
          ...
          <FormProvider {...form}>
            ...
            >
              ...
              <div className="w-full">
                ...
                <select
                  onChange={(e) => form.setValue("course_id", e.target.value)}
                  className=" block w-full p-2 border border-gray-300 rounded"
                  required
                >
              ...
              <div className="w-full">
                ...
                <select
                  onChange={(e) => form.setValue("user_id", e.target.value)}
                  className=" block w-full p-2 border border-gray-300 rounded"
                  required
                >
