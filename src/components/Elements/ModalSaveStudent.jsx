    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 z-50 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded shadow-lg w-full max-w-[600px]">
          ...
          <FormProvider {...form}>
            <form
              onSubmit={form.handleSubmit(handleSubmitIntruct)}
              className="mt-4 flex flex-col items-start w-full gap-2"
            >
              ...
              <div className="flex gap-2 items-center w-full">
                <div className="w-full">
                  ...
                  <input
                    placeholder="Insira o numero de telemovel"
                    type="text"
              ...
              <div className="flex gap-2 items-center w-full">
                <div className="w-full">
                  ...
                  <select
                    onChange={(e) => form.setValue("id_type", e.target.value)}
                    className=" block w-full p-2 border border-gray-300 rounded"
                    required
                  >
                ...
                <div className="w-full ">
                  ...
                  <input
                    placeholder="Informe o numero de indentificação"
                    type="text"
              ...
              <div className="w-full">
                ...
                <input
                  placeholder="Observações do estudante"
                  type="text"
              ...
              <div className="w-full flex items-center justify-end gap-2">
                <Dialog.Close asChild>
                  <button className="px-4 py-2 ring-zinc-300 ring-1 rounded ">
                    Cancelar
                  </button>
                </Dialog.Close>
                <button
